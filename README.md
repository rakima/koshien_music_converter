...
4. 装飾音除去、音高統合、8分音符量子化、単旋律化を行う
5. ノートを最大1拍のスタッカート奏法へ変換する
6. FluidSynthとSoundFontでMIDIをトランペット音にする
7. 推定BPMに同期した「ドン ドン ドドン ドン」を生成する
8. 生成ラッパと生成太鼓だけをミックスする
9. コンプレッサー、ラウドネス調整、リミッターで約-1 dBFSに整える
